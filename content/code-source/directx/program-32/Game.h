...
private:
	...
	// PLAYER DATA
	DirectX::XMFLOAT3 m_PlayerPos = { 0.0f, 2.0f, 0.0f }; // +|- (( RIGHT|LEFT ))  (( UP|DOWN ))  (( FRONT|BACK ))
	...
	// MENU DATA
	D2D1_RECT_F m_menuOpt1Rect;
	D2D1_RECT_F m_menuOpt2Rect;
	D2D1_RECT_F m_menuOpt3Rect;
