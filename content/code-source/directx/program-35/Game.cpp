...
void MyDX3DGame::OnResize(UINT width, UINT height)
{
	...
	// ==========================================
	// PASSO 1: LIMPEZA COMPLETA (OBRIGATÓRIO)
	// ==========================================
	...
	// ==========================================
	// PASSO 2: REDIMENSIONAR OS BUFFERS DA GPU
	// ==========================================
	...
	if (FAILED(hr))
	{
		OutputDebugStringA("Falha crítica ao redimensionar a Swap Chain!\n");
		return;
	}

	// ==========================================
	// PASSO 3: RECONSTRUIR RECURSOS DO DIRECT3D
	// ==========================================
	...
	// ==========================================
	// PASSO 4: RECONSTRUIR RECURSOS DO DIRECT2D
	// ==========================================
