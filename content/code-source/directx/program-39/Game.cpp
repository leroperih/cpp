...
bool MyDX3DGame::CapsuleBufferSweep(
	DirectX::XMVECTOR capsuleOrigin,
	...
	if (LoadOBJ(objPath.c_str(), txtPath.c_str(), mapVertices)) {
		...
		switch ( m_SelectedMap )
		{
			...
			case 0:
					...
					{
					CreateDoor(DirectX::XMFLOAT3(2.9f, 0.0f, 0.48f), 0.0f, 0.0f, false);
					}
...
LRESULT MyDX3DGame::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
...

			{
				...
				{
					int maxOptions;
					if (m_CurrentGameState == GameState::Settings) maxOptions = m_settings_MaxOptions;
					else if (m_CurrentGameState == GameState::Pause) maxOptions = m_pause_MaxOptions;
					else if (m_CurrentGameState == GameState::Initial_Menu) maxOptions = m_initial_MaxOptions;
